...
BOOL  testMessageDialog()
{
   ...
   displayMessageDialogf(NULL, IDS_GENERAL_NOT_IMPLEMENTED, MAKEINTRESOURCE(IDS_TITLE_NOT_IMPLEMENTED), MDF_OK WITH MDF_INFORMATION, TEXT("Command descriptions"));*/
   return TRUE;
}
