...
VOID   initCorrectionDialog(HWND  hDialog, CORRECTION_DIALOG_DATA*  pDialogData)
{
   ...
   {
   case RT_COMMANDS:        drawRichTextInRichEdit(GetControl(hDialog, IDC_CORRECTION_DESCRIPTION_RICHEDIT), pDialogData->xResult.asCommandSyntax->pTooltipDescription, GTC_WHITE, FALSE);   break;
   case RT_GAME_OBJECTS:    drawRichTextInRichEdit(GetControl(hDialog, IDC_CORRECTION_DESCRIPTION_RICHEDIT), pDialogData->xResult.asObjectName->pDescription,           GTC_WHITE, FALSE);   break;
   case RT_SCRIPT_OBJECTS:  drawRichTextInRichEdit(GetControl(hDialog, IDC_CORRECTION_DESCRIPTION_RICHEDIT), pDialogData->xResult.asObjectName->pDescription,           GTC_WHITE, FALSE);   break;
   }
