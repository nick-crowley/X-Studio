...
BOOL  findNextXMLToken(XML_TOKENISER*  &pOutput, ERROR_STACK*  &pError)
{
   ...
   if (!pError AND szTokenEnd)
   {
      ...
      case XTT_COMMENT_TAG:
         ...
         case XTT_OPENING_TAG:
            ...
            StringCchCopyN(pOutput->szText, 4096, &szTokenStart[1], pOutput->iCount);
         ...
         case XTT_CLOSING_TAG:
            ...
            StringCchCopyN(pOutput->szText, 4096, &szTokenStart[2], pOutput->iCount);
         ...
         case XTT_COMMENT_TAG:
            ...
            StringCchCopyN(pOutput->szText, 4096, &szTokenStart[4], pOutput->iCount);
      ...
      case XTT_TEXT:
         ...
         pOutput->iCount = min(4096, szTokenEnd - szTokenStart);
         StringCchCopyN(pOutput->szText, 4096, szTokenStart, pOutput->iCount);
   ...
   else
   {
      ...
      StringCchCopy(pOutput->szText, 4096, szTokenStart);
